...
async function createUsersTable() {
  try {
    ...
    console.error("Error building user table!");
    throw error;
  }
}
...
async function createActivitiesTable() {
  try {
    ...
    console.error("Error building activities table!");
    throw error;
  }
}
...
async function createRoutinesTable() {
  try {
    ...
    console.error("Error building routines table!");
    throw error;
  }
}

async function createRoutineActivitiesTable() {
  try {
    await client.query(`
    ...
    console.error("Error building routine activities table!");
    throw error;
  }
}
...
async function createTables() {
  try {
    ...
    //users, activities, routines, routine_activities
    await createUsersTable();
    await createActivitiesTable();
    await createRoutinesTable();
    await createRoutineActivitiesTable();
  } catch (error) {
